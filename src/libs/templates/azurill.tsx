      ...
      >
        {section.items
          ...
          .map((item) => {
            ...
            const url = urlKey && itemAsAny[urlKey] ? itemAsAny[urlKey] as URL : undefined;
            const level = levelKey && typeof itemAsAny[levelKey] === 'number' ? itemAsAny[levelKey] : undefined;
            const summary = summaryKey && typeof itemAsAny[summaryKey] === 'string' ? itemAsAny[summaryKey] : undefined;
            const keywords = keywordsKey && Array.isArray(itemAsAny[keywordsKey]) ? itemAsAny[keywordsKey] as string[] : undefined;
...
export const Azurill = ({ columns, isFirstPage = false }: any) => {
  ...
  return (
    <div className="a4-resume mx-auto bg-white" data-page="testing" style={{
      width: '210mm',
      minHeight: '297mm',
      maxWidth: '210mm',
      padding: '20mm',
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-3 gap-x-4">
          ...
          <div
            className={cn('main group space-y-4 col-span-2')}
          >
